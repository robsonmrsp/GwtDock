...
public class Teste_telas implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		dockDesktop.getBottomDock().addItem("images/calendar.png", "Calendario");
		dockDesktop.getBottomDock().addItem("images/link.png", "Links");
		dockDesktop.getBottomDock().addItem("images/rss.png", "Rss");
	...
	private DockMenu createDockMenu() {
		...
		// });
		//
		// DockItem dockItemPortFolio = new DockItem("images/portfolio.png",
		// "Portfolio");
		// DockItem dockItemMusic = new DockItem("images/music.png", "Musicas");
		// DockItem dockItemVideo = new DockItem("images/video.png", "Videos");
		// DockItem dockItemHistory = new DockItem("images/history.png",
		// "Historico");
		// DockItem dockItemCalendar = new DockItem("images/calendar.png",
		// "Calendario");
